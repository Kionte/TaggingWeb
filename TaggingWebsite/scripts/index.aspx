<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="TaggingWebsite.scripts.index" %>
...
<body>
    ...
    <div style="text-align:center">
       ...
       <asp:table style=" text-align:center;width:65.8%; border:2px;border-radius:1000px; margin-left:auto;margin-right:auto" id="myTable" runat="server" /> <!--comments are cool-->
    </div>
    </form>
</body>
</html>
