<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="newUser.aspx.cs" Inherits="TaggingWebsite.scripts.newUser" %>
    ...
    <form id="form1" runat="server">
        ...
        <div style="text-align:center">
            <table style="width:50%; margin-top: 100px; margin-left:auto; margin-right:auto">
                <tr>
                    <td style="font-size: 20px;text-align:center">New User</td>
                </tr>
                <tr>
                    <td style="text-align: center">Username</td>
                        <td>
                            <input runat="server" id ="fillUsername" type ="text"/>
                        </td>
                </tr>
                <tr>
                    <td>Password</td>
                    <td>
                        <input id="fillPassword" runat="server" type ="text" />
                    </td>
                </tr>
                <tr>
                    <td>Email</td>
                    <td>
                        <input id="fillEmail" runat="server" type ="text"/>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <button id="submitUser" runat="server" onserverclick="createUser">Create</button>
                    </td>
                </tr>
            </table>
        </div>
